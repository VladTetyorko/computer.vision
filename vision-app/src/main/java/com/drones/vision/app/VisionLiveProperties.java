 ...
 * item 4).
 *
 * <p>Selected by {@link WiringConfiguration#liveUpdatePublisherPort}: {@link #enabled()} {@code
 * true} (the default) wires the real {@code com.drones.vision.api.live.LiveUpdateRegistry} (also
 * where {@code /api/live}'s own {@code @ConditionalOnProperty} reads the exact same {@code

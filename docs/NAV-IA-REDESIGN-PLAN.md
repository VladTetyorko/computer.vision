...
Per-page design files live in [`docs/design/`](design/). This file owns the **shell**, the
...
- The Component→Facade→Store→Service layering (`docs/UI-ARCHITECTURE-PLAN.md`) and
...
| Page | File |
|---|---|
| App shell / navigation | [`design/00-shell.md`](design/00-shell.md) |
| Fly — picker + cockpit | [`design/01-fly.md`](design/01-fly.md) |
| Command | [`design/02-command.md`](design/02-command.md) |
| Wall | [`design/03-wall.md`](design/03-wall.md) |
| Assets | [`design/04-assets.md`](design/04-assets.md) |
| Asset detail | [`design/05-asset-detail.md`](design/05-asset-detail.md) |
| Devices | [`design/06-devices.md`](design/06-devices.md) |
| Add source | [`design/07-add-source.md`](design/07-add-source.md) |
| Alerts center | [`design/08-alerts.md`](design/08-alerts.md) |
| Activity | [`design/09-activity.md`](design/09-activity.md) |
| Replay | [`design/10-replay.md`](design/10-replay.md) |
| Settings | [`design/11-settings.md`](design/11-settings.md) |
| Organization | [`design/12-org.md`](design/12-org.md) |
| Pilots / roster | [`design/13-roster.md`](design/13-roster.md) |
| Asset categories | [`design/14-categories.md`](design/14-categories.md) |
| Inventory reports | [`design/15-reports.md`](design/15-reports.md) |
| CV training | [`design/16-training.md`](design/16-training.md) |
| Pre-flight | [`design/17-preflight.md`](design/17-preflight.md) |
| Debug | [`design/18-debug.md`](design/18-debug.md) |
| Hubs (removed) | [`design/19-hubs.md`](design/19-hubs.md) |

...
Companions: docs/FEATURE-MATRIX.md
(effort/value by persona, 2026-07-25), docs/ANY-DRONE-PLAN.md (the integration loop),
docs/MOAT.md (why this is the product). This doc asks a narrower question than FEATURE-MATRIX:

...
docs/plans/done/FC-INTEGRATIONS-PLAN.md (decode), docs/plans/active/DRONE-INFRA-PLAN.md (gateway I-a, discovery I-b, guided
onboarding I-g, command TX I-e), docs/plans/active/RC-CONTROL-PLAN.md. Companion: docs/conclusions/MOAT.md (why this matters
...
because they are the funnel through which every other feature is reached. See docs/conclusions/MOAT.md §4.

...
Companion to [ARCHITECTURE.md](../../../ARCHITECTURE.md) and [UX-DESIGN.md](../../main/UX-DESIGN.md). Delivers the product surfaces of the UX design as a single-page Angular application with tabbed top-level navigation, built and shipped as part of the Maven reactor.
...
Implements the three-tier disclosure model of [UX-DESIGN §4](../../main/UX-DESIGN.md):

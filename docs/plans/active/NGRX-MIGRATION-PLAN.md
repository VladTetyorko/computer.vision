...
| N8, N9 | open — headroom is 37.66 kB, less than N6's own +47.21 kB single-wave cost, so N8 should expect to need its own split too if it lands any root-registered slice |

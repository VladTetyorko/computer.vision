...
| **V4** | `assign.py` · `params.py` | **L1** | `crossing_similar` keeps both ids where V0 shows a swap; each of `w_mom`/`w_cue`/`w_occ` set to zero individually reproduces the V2 scoreboard (**P7**) |

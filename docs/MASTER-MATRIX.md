...
| Doc | Answers |
|---|---|
| docs/MOAT.md | *why* — the four structural inversions of a vendor platform |
| docs/ANY-DRONE-PLAN.md | *how any drone gets in* — PROBE→DIAGNOSE→REMEDIATE→VERIFY |
| docs/BASE-COMPUTE-MATRIX.md | *what the base computes* — the offload law, advisory autonomy |
| docs/DRONE-COMPONENTS-MATRIX.md | *what it costs* — position stack, link stack, components, Anubis |
| docs/FEATURE-MATRIX.md | prior persona/effort survey (2026-07-25), still valid, narrower axes |

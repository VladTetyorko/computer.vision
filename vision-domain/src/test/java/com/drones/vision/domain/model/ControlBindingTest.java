...
class ControlBindingTest {
    ...
    private static ControlBinding axis(double deadband, boolean reversed) {
        return new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 1500, 2000, deadband, reversed);
    }

    private static ControlBinding button(double deadband, boolean reversed) {
        return new ControlBinding(ControlBinding.Source.BUTTON, 0, 5, 1000, 1000, 2000, deadband, reversed);
    }
    ...
    void rejectsNullSource() {
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(null, 0, 1, 1000, 1500, 2000, 0.0, false));
    }

    @Test
    void rejectsNegativeSourceIndex() {
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, -1, 1, 1000, 1500, 2000, 0.0, false));
    }

    @Test
    void rejectsRcChannelOutOfRange() {
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 0, 1000, 1500, 2000, 0.0, false));
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 19, 1000, 1500, 2000, 0.0, false));
    }

    @Test
    void rejectsMicrosOutsideDeviceRange() {
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 999, 1500, 2000, 0.0, false));
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 1500, 2001, 0.0, false));
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 2001, 2000, 0.0, false));
    }

    @Test
    void rejectsOutOfOrderMicros() {
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1600, 1500, 2000, 0.0, false));
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 1500, 1400, 0.0, false));
    }

    @Test
    void acceptsMinEqualsCenterEqualsMax() {
        ControlBinding binding = new ControlBinding(ControlBinding.Source.BUTTON, 0, 5, 1500, 1500, 1500, 0.0, false);
    ...
    void rejectsDeadbandOutsideZeroToOne() {
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 1500, 2000, -0.01, false));
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 1500, 2000, 1.01, false));
        assertThrows(IllegalArgumentException.class,
                () -> new ControlBinding(ControlBinding.Source.AXIS, 0, 1, 1000, 1500, 2000, Double.NaN, false));
    }

...
/**
 * Wrapper body for {@code GET /api/datasets} (docs/CV-TRAINING-PLAN.md §3's frozen wire contract)
 ...
 *
 * @param datasets a scope-filtered snapshot, in {@link com.drones.vision.application.DatasetService#list}'s
 *                 own order
 */

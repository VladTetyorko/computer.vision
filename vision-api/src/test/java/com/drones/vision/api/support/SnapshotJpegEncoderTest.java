...
class SnapshotJpegEncoderTest {
    ...
    private final SnapshotJpegEncoder encoder = new SnapshotJpegEncoder(VisionApiProperties.defaults());
    ...
    void encodeThrowsForAnUnsupportedPixelFormat() {
        ...
        IllegalStateException ex = assertThrows(IllegalStateException.class, () -> encoder.encode(frame));

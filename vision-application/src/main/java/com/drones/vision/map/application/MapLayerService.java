 ...
 * (404); an in-scope-but-insufficient access level is {@link com.drones.vision.identity.application.scope.AccessDeniedException} (403).
 *
 * <h2>The COP layer</h2>
...
public interface MapLayerService {
     ...
     * @throws com.drones.vision.identity.application.scope.AccessDeniedException if {@code spec.kind()} is {@link LayerKind#TEAM} and {@code v} is

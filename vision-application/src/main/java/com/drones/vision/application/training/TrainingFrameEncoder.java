...
final class TrainingFrameEncoder {
    ...
    /** Default {@link #jpegQuality}, byte-identical to the literal this replaces. */
    private static final float JPEG_QUALITY = 0.9f;

    private final float jpegQuality;

    /** Uses {@link #JPEG_QUALITY}'s default. */
    TrainingFrameEncoder() {
        this(JPEG_QUALITY);
    }

    TrainingFrameEncoder(float jpegQuality) {

 ...
 *            Telemetry})
 */
final class SupervisedPublisher<T> implements Flow.Publisher<T> {
    ...
    /** Test seam: same as the 3-argument constructor, with explicit (typically much smaller) backoff bounds. */
    SupervisedPublisher(Supplier<Flow.Publisher<T>> opener, Consumer<Throwable> onOutageBegan,

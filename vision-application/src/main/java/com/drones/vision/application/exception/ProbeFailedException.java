...
import com.drones.vision.application.device.DefaultProbeService;
/**
 ...
 *
 * <p>Deliberately distinct from {@link UnsupportedProtocolException} (an unrecognized protocol —
 * a malformed request, mapped to 400) — this exception means the request was well-formed and the

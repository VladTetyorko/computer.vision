...
public interface LabelingService {
     ...
     * {@link com.drones.vision.perception.application.stream.StreamService#latestRawFrame} (full-resolution, pre-overlay) and {@link
     * com.drones.vision.perception.application.stream.StreamService#latestDetections}, maps every detection to a {@link
     ...
     * path. Pulls one decoded frame via {@link com.drones.vision.events.application.ReplaySources#frames()} at {@code

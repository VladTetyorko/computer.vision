 ...
 *
 * Awaits `AuthFacade.ready` first, same as `auth-guard.ts`/`org-guard.ts` — the decision runs
 ...
 * dev principal to the full capability set (`AuthFacade`'s own fixed dev-admin shape) — which is the

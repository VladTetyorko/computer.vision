...
import { detectionsEffects } from './detections.effects';
 ...
 */
export function provideDetectionsState() {
  return makeEnvironmentProviders([provideState(detectionsFeature), provideEffects(detectionsEffects)]);
}

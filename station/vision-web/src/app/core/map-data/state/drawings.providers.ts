...
/**
 * The `drawings` slice + its effects, registered by the routes that use it instead of at the root
 ...
 */
export function provideDrawingsState() {
  return makeEnvironmentProviders([provideState(drawingsFeature), provideEffects(drawingsEffects)]);
}

 ...
 * (docs/plans/done/NAV-IA-REDESIGN-PLAN.md Wave 1, docs/extracts/design/19-hubs.md). Split into its own file per
 ...
 * (docs/plans/done/NAV-IA-REDESIGN-PLAN.md F1: "Every task that starts from a mode costs one extra click and

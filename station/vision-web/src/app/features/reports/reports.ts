...
/**
 * `/manage/reports` — docs/plans/done/UI-REDESIGN-PLAN.md Wave 4's **SPLIT** "Inventory reports": the read-only
 ...
 *
 * **Page bar (docs/plans/done/NAV-IA-REDESIGN-PLAN.md §2.2, docs/extracts/design/15-reports.md, wave 2).** The old
 ...
 * out of this wave's scope** (docs/plans/done/NAV-IA-REDESIGN-PLAN.md's own wave-2 brief) — this page's content

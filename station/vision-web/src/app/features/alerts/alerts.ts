...
/**
 * `/monitor/alerts` — docs/plans/done/NAV-IA-REDESIGN-PLAN.md Wave 3 (§2.4, docs/extracts/design/08-alerts.md): a
 ...
 *
 * **Two-pane, not the embedded rail (docs/extracts/design/08-alerts.md's own acceptance criteria).** Rows are

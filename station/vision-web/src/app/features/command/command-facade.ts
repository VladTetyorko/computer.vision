 ...
 * needs (`FleetStore`, `MapFacade`, `GeofenceFacade`, `LiveFacade`, `WeatherStore`, `VisionApi`,
 ...
 *
 * **Provided per route activation**, listed alongside `MapFacade`/`WeatherStore` in
...
export class CommandFacade {
  ...
  /** §3.4's on-demand route fetch — page-provided alongside `MapFacade`/`WeatherStore` in

 ...
 * split out (docs/plans/active/CV-DEMAND-PLAN.md &sect;3.8) so that controller can add a {@link
 ...
 * StreamService} was dropped from this class's own collaborators (docs/plans/active/CV-CLEAN-FEED-PLAN.md

...
/**
 * Response body for {@code GET /api/system/status} (docs/plans/done/SYSTEM-STATUS-PLAN.md §4.3's
 ...
 * (docs/plans/done/SYSTEM-STATUS-PLAN.md §4.3): an operator whose CV has died must be able to see

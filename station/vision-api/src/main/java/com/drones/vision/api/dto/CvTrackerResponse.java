...
/**
 * One entry in {@code GET /api/cv/trackers}'s roster (docs/plans/done/TRACKING-PLAN.md &sect;4.F's frozen wire
 ...
 * vision-app} bean, docs/plans/done/CV-CONTROL-PLAN.md &sect;D's frozen decision applied to trackers).
 *
 ...
 *                    (docs/extracts/TRACKING-ORCHESTRATION.md &sect;2.2), so the picker never offers an

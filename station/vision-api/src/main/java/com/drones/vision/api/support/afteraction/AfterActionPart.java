...
/**
 * One row of an after-action manifest's {@code parts} array (docs/plans/active/AFTER-ACTION-PLAN.md
 ...
 *              PRESENT} and there is nothing to qualify (docs/plans/active/AFTER-ACTION-PLAN.md

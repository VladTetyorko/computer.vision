...
/**
 * Driving REST adapter for the tracker-engine roster (docs/plans/done/TRACKING-PLAN.md §4.F's frozen wire
 ...
 * runtime (docs/plans/done/CV-CONTROL-PLAN.md §D's frozen decision, mirrored for trackers by
 * docs/plans/done/TRACKING-PLAN.md §4.F). {@code vision-app}'s {@code TrackingWiring#cvTrackerRoster} supplies
 * the content.
 *
 * <p><b>Deliberately not an RPC to cv-service.</b> docs/extracts/TRACKING-ORCHESTRATION.md's risk R11 asked
 ...
 * docs/plans/done/TRACKING-PLAN.md §4.F allowed): the two rosters share no collaborator, and folding them would

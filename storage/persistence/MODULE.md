...
**Build/test:** `./mvnw -B -pl storage/persistence test` — 286 tests (count from Maven's own summary
...
| Flyway migration ledger, V1 through V36 | API surface → Schema |
...
### Schema (`src/main/resources/db/migration`) — migration ledger, V1 through V36

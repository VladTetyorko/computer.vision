...
**Build:** `./mvnw -B -pl vision-kernel,vision-platform,contexts/vision-warehouse,contexts/vision-identity,contexts/vision-flight,contexts/vision-perception,contexts/vision-map,contexts/vision-events,contexts/vision-learning,contexts/vision-simulation install -DskipTests` then `./mvnw -B -pl adapters/adapter-persistence,vision-api,vision-app test -DskipWeb` — green. Never run reactor-wide builds.

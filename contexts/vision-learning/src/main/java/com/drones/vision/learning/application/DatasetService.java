...
public interface DatasetService {
     ...
     *                  edge from the acting user, the same way {@link com.drones.vision.warehouse.application.asset.AssetService#create} and
     *                  {@link com.drones.vision.map.application.mark.MarkService#create} are — never derived from {@code scope} here,

 ...
 * com.drones.vision.flight.domain.port.FlightCommandPort} (docs/plans/active/DRONE-INFRA-PLAN.md I-e, Stage 1).
 *
 * <p>An explicit refusal by the aircraft is deliberately <b>not</b> a value of this enum — see
 * {@link com.drones.vision.flight.domain.port.FlightCommandPort}'s own javadoc for why that is

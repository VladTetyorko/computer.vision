...
**Build/test:** `./mvnw -B -pl video-input/v4l2 test` — 22 tests across 3 classes:
...
`VISION_V4L2_TEST_DEVICE=/dev/video9 ./mvnw -B -pl video-input/v4l2 test`. A real, unoccupied
...
22 tests, all passing (`./mvnw -B -pl video-input/v4l2 test`).

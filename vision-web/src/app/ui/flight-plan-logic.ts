...
/**
 * Pure logic behind `ui/flight-plan-dialog.ts` (docs/CYCLES-PLAN.md §7, CT-b) — waypoint list
 ...
 * unit-testable without Leaflet, a component, or the DOM — mirrors `ui/detection-overlay-logic.ts`
 * and `ui/player-recovery.ts`'s split of pure state/derivation from the component that drives it.
 */

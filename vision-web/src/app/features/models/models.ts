...
/**
 * `/manage/training/models` — the CV model registry (docs/CV-TRAINING-PLAN.md Phase 2 T10): every
 ...
 * training/start-training UI here — training itself runs offline (docs/CV-TRAINING-PLAN.md's own

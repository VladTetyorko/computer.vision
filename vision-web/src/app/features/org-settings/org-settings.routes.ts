...
/**
 * The `/org` route (docs/U-SCOPE-PLAN.md, U-e slice 2) — org-settings, own lazy chunk, split into
 * its own file per vision-web/docs/UI-STRUCTURE-PLAN.md §2.3/§3 (B8). Spread inside

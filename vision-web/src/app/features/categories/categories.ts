 ...
 *
 * **`page-head` → `vision-page-bar`** (docs/NAV-IA-REDESIGN-PLAN.md §2.2, docs/design/14-categories.md):
 ...
 * different numbers). The empty-category grouping and column drop docs/design/14-categories.md

...
import { TELEMETRY_AGE_RED_SECONDS } from '../../core/telemetry-logic';
 ...
 * (`pages/fly/fly-logic.ts`, `core/map-logic.ts`, etc.).
 *
 ...
 * `core/telemetry-logic.ts#TELEMETRY_AGE_RED_SECONDS` directly rather than re-deriving the same
 ...
 * `pages/command/live-strip-tile.ts` (mirroring `pages/wall/wall-tile.ts`'s identical visibility

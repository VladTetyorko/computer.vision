 ...
 * without HTTP, timers, or Leaflet — mirrors `core/telemetry-logic.ts`.
 *
 * `groupTelemetryByDevice`/`telemetryDevices` used to live here too; moved to
 * `core/telemetry-logic.ts` in docs/MVP2-PLAN.md §R (R-b) when the replay cockpit needed the
 ...
 */
export { groupTelemetryByDevice, telemetryDevices } from '../../core/telemetry-logic';

"""Unit tests for `cv_service.concurrency`: `LatestOnlyMailbox`, `InferenceGate`,
and the `CV_MAX_CONCURRENT_INFERENCES` env var parsing.

Pure stdlib (`threading`) -- no `cv`/gRPC extras needed to run these.
"""
...
from cv_service.concurrency import (
    InferenceGate,
    LatestOnlyMailbox,
...
# --- CV_MAX_CONCURRENT_INFERENCES parsing --------------------------------------
